...
function CarouselFade() {
  return (
    <Carousel fade interval={1000} className={classes.carousel}>
      <Carousel.Item>
        <img className="d-block w-100" src={"https://i.imgur.com/MXnI2Zr.jpg"} alt="First slide" />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img className="d-block w-100" src={"https://i.imgur.com/ZP5HUJX.jpg"} alt="Second slide" />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img className="d-block w-100" src={"https://i.imgur.com/B4X3iTl.jpg"} alt="Third slide" />
        <Carousel.Caption>
